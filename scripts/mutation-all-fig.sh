...
# /usr/local/bin/bash ./mutation_fig6.sh -t 10 -vr
...
# /usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS fixsuite-r48
# /usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS javassist-3.19
# /usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS jdom-1.0
# /usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS commons-collections4-4.0
...
# Test running different version j8
#./mutation_fig6.sh $MUTATION_ARGS bcel-5.2
#./mutation_fig6.sh $MUTATION_ARGS ClassViewer-5.0.5b
# /usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS commons-codec-1.9
#/usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS hamcrest-core-1.3
#/usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS nekomud-r16
#/usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS tinySQL-2.26
# /usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS commons-compress-1.8

#/usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS commons-primitives-1.0
#/usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS javax.mail-1.5.1
#/usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS jcommander-1.35
#/usr/local/bin/bash ./mutation_fig6.sh $MUTATION_ARGS pmd-core-5.2.2
