...
4. NOTE: You can skip this step if you intend to use the EvoSuite script. 
   Clone the Randoop repository from GitHub. After cloning, go to the Randoop directory and build the
