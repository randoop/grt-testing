...
# Output
#===============================================================================
# `results/fig8-9.csv`:   Contains raw data collected from `mutation.sh`. This file is
#                              appended to by each experimental run.
# `results/fig8-9.pdf`: Final report containing Figures 8-9, generated from
#                              `results/fig8-9.csv`.
#
#===============================================================================
# Important Notes
...
# (results/fig8-9.pdf and results/fig8-9.csv).
