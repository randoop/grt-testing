...
# Output
#===============================================================================
# `results/fig8-9-info.csv`:   Contains raw data collected from `mutation.sh`. This file is
#                              appended to by each experimental run.
# `results/fig8-9-report.pdf`: Final report containing Figures 8-9, generated from
#                              `results/info.csv`.
#
#===============================================================================
# Important Notes
...
# (results/fig8-9-report.pdf and results/fig8-9-info.csv).
...
rm -f $MUTATION_DIR/results/fig8-9-report.pdf
rm -f $MUTATION_DIR/results/fig8-9-info.csv
...
run_task() {
  ...
  feature=$4
  num_loop=$5
  echo "Running: (cd $mutation_dir && ./mutation.sh -c $tseconds -f $feature -r -i fig8-9 -n $num_loop $program)"
  (cd "$mutation_dir" && ./mutation.sh -t "$tseconds" -f "$feature" -r -i "fig8-9" -n "$num_loop" "$program")
}
...
# Outputs figures to result/fig8-9-report.pdf
