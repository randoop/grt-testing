...
# Output
#===============================================================================
# `results/fig6-table3.csv`: Raw data produced by `mutation.sh`. This file is
#                            appended to by each run of `mutation.sh`.
# `results/fig6-table3.pdf`: Final report containing Figure 6 and Table 3,
#                            generated from `results/fig6-table3.csv`.
#
#===============================================================================
# Important Notes
#===============================================================================
# Running this script will overwrite previous files generated by this script
# (results/fig6-table3.pdf and results/fig6-table3.csv).
